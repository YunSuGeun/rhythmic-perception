%% Fig6 Adjusted R2 violin plots split and pooled by Validity and Measure
...
fprintf('--- FIG6 ADJUSTED R2 VIOLIN SPLIT  START ---\n');
drawnow('update');
...
figureDir = fullfile(projectRoot, '03_Figure', 'Figure6');
...
modelNames = ["M1", "M2", "M3"];
modelLabels = {'Monotonic Decay', 'Sustained Oscillation', 'Damped Oscillation'};
...
% Save stats
statsName = 'adjusted_r2_split_violin_paired_zero_wilcoxon_stats_averaged.csv';
...
% Save pooled stats
statsPooledName = 'adjusted_r2_pooled_violin_paired_zero_wilcoxon_stats_averaged.csv';
writetable(statsPooledAll, fullfile(statsDir, statsPooledName));

fprintf('--- FIG6 ADJUSTED R2 VIOLIN SPLIT  COMPLETE ---\n');
