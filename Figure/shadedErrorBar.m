function varargout=shadedErrorBar(x,y,errBar,lineProps,transparent,PS,LW,Lalpha)
% Modyfied by YL 2020.06.17 --> Adding Linewidth module 
...
if nargin<7, LW=0.5; end
if nargin<6, PS=0.15; end
if nargin<8, Lalpha=1; end



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
% Plot to get the parameters of the line 
H.mainLine=plot(x,y,lineProps{:},'linewidth',LW);
H.mainLine.Color(4)=Lalpha;
...
patchSaturation=PS; %How de-saturated or transparent to make patch
if transparent
